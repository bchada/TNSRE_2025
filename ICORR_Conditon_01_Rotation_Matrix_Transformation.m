...
axangSC_r2 = [0.0153 0.9892987 -0.14509996 -0.0126711408266963];
rotmSC_r2 = axang2rotm(axangSC_r2);
axangSC_r3 = [-0.99447254 0 -0.10499695 0.00536689720892803];
rotmSC_r3 = axang2rotm(axangSC_r3);
rotmSC = rotmSC_r2 * rotmSC_r3;
%% <Body name="clavphant_r">, <CustomJoint name="unrotscap_r">
axangCC_r3 = [-0.99447254 0 -0.10499695 -0.00536689720892803];
rotmCC_r3 = axang2rotm(axangCC_r3);
axangCC_r2 = [0.0153 0.9892987 -0.14509996 0.0126711408266963];
rotmCC_r2 = axang2rotm(axangCC_r2);
rotmCC = rotmCC_r3 * rotmCC_r2;
%% <Body name="scapula_r">, <CustomJoint name="acromioclavicular_r">
axangCS_r2 = [0.15709493 0.94726859 -0.27929088 -0.00256564826657552];
rotmCS_r2 = axang2rotm(axangCS_r2);
axangCS_r3 = [-0.75408404 0.29759402 0.58548703 0.0207346668075555];
rotmCS_r3 = axang2rotm(axangCS_r3);
axangCS_r1 = [0.63769985 0.11859997 0.76109982 0.00932009002953642];
rotmCS_r1 = axang2rotm(axangCS_r1);
rotmCS = rotmCS_r2 * rotmCS_r3 * rotmCS_r1;
%% <Body name="scapphant_r">, <CustomJoint name="unrothum_r">
axangSS_r1 = [0.63769985 0.11859997 0.76109982 -0.00932009002953642];
rotmSS_r1 = axang2rotm(axangSS_r1);
axangSS_r3 = [-0.75408404 0.29759402 0.58548703 -0.0207346668075555];
rotmSS_r3 = axang2rotm(axangSS_r3);
axangSS_r2 = [0.15709493 0.94726859 -0.27929088 0.00256564826657552];
...
axangSH_elvAng = [0.0048 0.99908918 0.04240001 -4.82402088528413e-010];
...
axangSH1_shElv = [-0.99826136 0.0023 0.05889802 0.0523599687049784];
rotmSH1_shElv= axang2rotm(axangSH1_shElv);
axangSH1_r2 = [0.0048 0.99908918 0.04240001 4.82402165340687e-010];
rotmSH1_r2= axang2rotm(axangSH1_r2);
rotmSH1 = rotmSH1_shElv * rotmSH1_r2;
%% Humerous is the same orientation as humpphant1_r
axangSH2_shRot = [0.0048 0.99908918 0.04240001 -3.74329886328361e-010];
...
axangHU_elbFl = [0.04940001 0.03660001 0.99810825 1.57079632788748];
rotmHU_elbFl= axang2rotm(axangHU_elbFl);
rotmHU = rotmHU_elbFl;
%% <Body name="radius_r">, <CustomJoint name="radioulnar_r">, <Coordinate name="pro_sup_r">
axangUR_proSup = [-0.01716099 0.99266564 -0.11966796 0.0436332314580177];
...
axangRP_dev = [-0.819064 -0.135611 -0.557444 -0.153588504580544];
...
% 										</SimmSpline>
% 									</function>
axangRP_flx = [0.95642673 -0.25220693 0.14710396 -0.511381436543561];
...
axangPrH_r1 = [0.8991357 -0.34905288 -0.26403991 -0.227749316700808];
rotmPrH_r1= axang2rotm(axangPrH_r1);
axangPrH_r3 = [0.99711853 0.01069999 -0.07510096 -0.255690718271781];
...
f_xyz_local = forceOffset(:,2:4);
f_rotMatrix = f_xyz_local * rotationAxisMatrix;
writematrix(f_rotMatrix, "external_force_rotMatrix_02_01_01")
f_startRotMatrix = readmatrix("external_force_rotMatrix_02_01_01.txt");
f_transInvRotMatrix = f_xyz_local * (inv(rotationAxisMatrix))';
writematrix(f_transInvRotMatrix, "external_force_transInvRotMatrix_02_01_01")
f_startTransInv = readmatrix("external_force_transInvRotMatrix_02_01_01.txt");
f_x_transInvRotationMatrixEnd = f_startTransInv(:,1);
f_y_transInvRotationMatrixEnd = f_startTransInv(:,2);
f_z_transInvRotationMatrixEnd = f_startTransInv(:,3);
f_x_RotMatrixEnd = f_startTransInv(:,1);
f_y_RotMatrixEnd = f_startTransInv(:,2);
f_z_RotMatrixEnd = f_startTransInv(:,3);